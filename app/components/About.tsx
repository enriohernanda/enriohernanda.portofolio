...
export default function About() {
  return (
    <section id="about" className="w-full py-24 bg-[#030712] transition-colors duration-300">
      <Container>
         {/* Heading */}
         <div className="flex flex-col items-center mb-16 px-4">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-extrabold text-white mb-6 text-center"
          >
            Curious about me?
          </motion.h2>
        </div>
        ...
        <div className="grid lg:grid-cols-1 gap-12 max-w-4xl mx-auto">
          ...
          >
            ...
            <p>
              My journey began with the fundamentals — HTML, CSS, and JavaScript — and has grown into hands-on experience using modern tools like <span className="text-indigo-400 font-medium">React.js, Next.js, and Tailwind CSS</span>. I enjoy turning complex designs into fully functional, responsive, and accessible web applications.
            </p>
            <p>
            ...
            <div className="pt-6 border-t border-slate-800">
               <h4 className="text-xl font-bold text-white mb-6 underline decoration-indigo-500/30 decoration-4 underline-offset-4">Quick facts about me:</h4>
