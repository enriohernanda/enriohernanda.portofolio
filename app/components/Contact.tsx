...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-full py-24 bg-white dark:bg-[#030712] transition-colors duration-300 relative overflow-hidden">
      ...
      <Container>
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white mb-6 text-center leading-tight"
          >
          ...
          <motion.p 
            ...
            className="text-center text-slate-600 dark:text-slate-400 max-w-xl text-lg"
          >
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <h4 className="text-xl font-bold text-slate-900 dark:text-white">Email Me</h4>
            <div className="flex items-center gap-3">
               <span className="text-lg md:text-xl font-medium text-slate-600 dark:text-slate-300">enriohernanda@gmail.com</span>
               <motion.button 
                whileTap={{ scale: 0.9 }} 
                onClick={() => copyToClipboard('enriohernanda@gmail.com', 'email')}
                className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors cursor-pointer relative"
               >
          ...
          >
            ...
            <h4 className="text-xl font-bold text-slate-900 dark:text-white">Call Me</h4>
            <div className="flex items-center gap-3">
               <span className="text-lg md:text-xl font-medium text-slate-600 dark:text-slate-300">+62 877 7350 7317</span>
               <motion.button 
                whileTap={{ scale: 0.9 }} 
        ...
        <div className="mt-20 flex flex-col items-center gap-8">
           <p className="text-sm font-bold tracking-widest uppercase text-slate-400 dark:text-slate-500">Find me on</p>
           <div className="flex items-center gap-6 p-3 rounded-2xl glass-card">
              {[
                ...
                <motion.a 
                  ...
                  whileTap={{ scale: 0.9 }} 
                  className="p-3 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 transition-all hover:border-indigo-500"
                >
                  <Image src={social.light} alt={social.alt} width={24} height={24} className="dark:hidden" />
                  <Image src={social.dark} alt={social.alt} width={24} height={24} className="hidden dark:block" />
                </motion.a>
              ))}
           </div>
        </div>
